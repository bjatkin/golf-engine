...
sprite sheet and map file. If there are any errors compiling your go code the golf toolkit will let you know.
...
anyone can then play your game using the ‘play <wasmfile.wasm>’ command in the golf toolkit.
